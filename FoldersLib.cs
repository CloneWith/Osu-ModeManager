...
namespace OsuModeManager
{
    ...
    public static class FoldersLib
    {
        ...
        public static string GetPath(Folders KnownFolder)
        {
            return GetPath(KnownFolder, false);
        }

        public static string GetPath(Folders KnownFolder, bool DefaultUser)
        {
            return GetPath(KnownFolder, FolderFlags.DontVerify, DefaultUser);
        }

        static string GetPath(Folders KnownFolder, FolderFlags Flags,
            bool DefaultUser)
        {
            var Result = SHGetFoldersPath(new Guid(_FolderGuiDs[(int)KnownFolder]), (uint)Flags,
        ...
        static extern int SHGetFoldersPath([MarshalAs(UnmanagedType.LPStruct)] Guid Rfid, uint DWFlags, IntPtr HToken,
            out IntPtr PpszPath);
